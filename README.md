# CCOpenKit — Claude Code Open Kit

**The free & open-source AI dev team for Claude Code.**  
135+ agents • 200+ skills • 40+ commands • 20+ hooks • One-command ship pipeline • Red-team reviewer • Agent Teams v2 • Problem-solving engine
...
- **Red-team code reviewer** + automated security/OWASP/dependency scans
- **135+ agents** & **200+ skills** from the best open sources (curated + credited)
...
27+ slash commands (prefixed cc: to avoid clashes)
20 specialized agents that actually talk to each other
7 behavioral modes + token-efficient output
...
rohitg00/awesome-claude-code-toolkit (135 agents + 400k SkillKit)
...
Made with ❤️ for the open-source agentic AI movement.
